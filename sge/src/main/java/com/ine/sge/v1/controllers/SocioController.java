...
public class SocioController implements com.ine.sge.interfaces.resource.ISocio {
	...
	@Transactional
	@RequestMapping(value = "/socios/{keyword}/search/{field}/byfield", method = RequestMethod.GET, produces = "application/json")
	@ApiOperation(value = "Retrieves given keyword", response=Socio.class)
	public ResponseEntity<Page<Socio>> searchByfield(@Valid @PathVariable String keyword, @Valid @PathVariable String field){
