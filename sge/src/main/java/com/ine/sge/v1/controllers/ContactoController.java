...
public class ContactoController implements com.ine.sge.interfaces.resource.IContacto {
	...
	@Transactional
	@RequestMapping(value = "/contactos/{keyword}/search/{field}/byfield", method = RequestMethod.GET, produces = "application/json")
	@ApiOperation(value = "Retrieves given keyword", response=Contacto.class)
	public ResponseEntity<Page<Contacto>> searchByfield(@Valid @PathVariable String keyword, @Valid @PathVariable String field){
