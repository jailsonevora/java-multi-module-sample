...
public interface INivel {
	...
	ResponseEntity<Page<Nivel>> showall(Pageable pageable);

	ResponseEntity<Void> create(@Valid @RequestBody Nivel newLevel);

	ResponseEntity<Void> update(@Valid @PathVariable Long id, @Valid @RequestBody Nivel toUpdate);
