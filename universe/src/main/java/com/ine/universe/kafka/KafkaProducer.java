...
public class KafkaProducer {
	...
	public void send(Entidade payload) {
		...
		System.out.println("Message Universe in Json: " + payload + " sent to topic: " + kafkaTopic);
		System.out.println("Message Universe in byte: " + message + " sent to topic: " + kafkaTopic);
	}
}
