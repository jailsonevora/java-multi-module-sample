...
import com.ine.universe.dao.IClassificacaoRepository;
...
@Api(value = "classificacoes", description = "Universe Classificacao API")
public class ClassificacaoController implements com.ine.universe.interfaces.resource.IClassificacao {
