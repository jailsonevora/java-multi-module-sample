...
import com.ine.universe.dao.IEstabelecimentoRepository;
...
@Api(value = "estabelecimentos", description = "Universe Estabelecimento API")
public class EstabelecimentoController implements com.ine.universe.interfaces.resource.IEstabelecimento {
