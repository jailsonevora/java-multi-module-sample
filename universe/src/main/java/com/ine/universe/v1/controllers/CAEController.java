...
import com.ine.universe.dao.ICAERepository;
...
@Api(value = "caes", description = "Universe CAE API")
public class CAEController implements com.ine.universe.interfaces.resource.ICAE {
