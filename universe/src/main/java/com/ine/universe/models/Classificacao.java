...
public class Classificacao<INivel extends com.ine.universe.models.Nivel> extends com.ine.universe.models.AuditModel<String> implements IClassificacao<INivel>, Serializable {
	...
	@ManyToMany(fetch = FetchType.LAZY,
			...
			targetEntity=com.ine.universe.models.Nivel.class
	)
